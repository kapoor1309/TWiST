...
def predict_and_save_triplet(model, test_loader, device, save_dir="predictions"):
    ...
    for batch_idx, batch in enumerate(test_loader):
        ...
        for i, frame_id in enumerate(frame_ids):
            ...
            video_id_str = f"VID{str(video_id[0].item()).zfill(2)}"
...
if __name__ == "__main__":
    ...
    predict_and_save_triplet(model, test_loader, device, save_dir="predictions")